...
public abstract class ObeliskItens {
...
public ObeliskItens(float cartasPadrao, float cartasTimeWizard, float acessorios, int produto, float quantidadeCartasPadrao, float quantidadeCartasTimeWizard, float quantidadeAcessorios, float valorFinal) {
